      ...
      <footer>
              ...
              <div>
                ...
                <div role="list" className="mt-4 space-y-4">
                  {navigation.general.map((item) => (
                    <Link key={item.name} href={item.href} className="block text-base text-gray-600 no-underline hover:text-gray-800 dark:hover:text-gray-300 dark:text-gray-400 hover:underline">
                      {item.name}
                    </Link>
                  ))}
                </div>
        ...
        <div className="flex items-center justify-between mt-12">
          ...
          <p className="order-1 text-base">
            &copy; {new Date().getFullYear()} Meagan Waller
          </p>
        </div>
      </footer>
    </>

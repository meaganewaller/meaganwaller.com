...
function NavItem({ href, text }: Props) {
  ...
  return (
    <NextLink href={href} className={`${
        ...
        } 'hidden md:inline-block p-1 sm:px-6 sm:py-2 rounded-full hover:bg-gray-100 dark:hover:bg-onyx transition-all`}
        >
      <span className={`${isActive ? 'py-1 border-b-2 border-teal-400 dark:border-teal-500' : 'capsize'}`}>
        {text}
      </span>
    </NextLink>
  );
    ...
    <div className="relative z-50 text-gray-900 dark:text-gray-100">
       <div className="flex items-center justify-between max-w-6xl px-4 py-6 mx-auto sm:px-6 md:space-x-10">
        ...
        <div className="-my-2 -mr-2 md:hidden" onClick={() => setIsOpen(true)}>
          <div className="bg-gray-200 dark:bg-onyx text-gray-600 dark:text-gray-300 rounded-full p-3.5 inline-flex items-center justify-center hover:text-gray-700 hover:bg-gray-300 cursor-pointer focus:outline-none general-ring-state">
        ...
        <div className="items-center justify-end hidden md:flex md:flex-1 lg:w-0">
          <button
            ...
            type="button"
            className="flex items-center justify-center w-12 h-12 bg-gray-200 rounded-full dark:bg-onyx general-ring-state"
            onClick={() =>
          ...
          <div className="fixed w-full max-w-xs p-6 text-base font-semibold text-gray-900 bg-white rounded-lg shadow-lg top-4 right-4 dark:bg-gray-800 dark:text-gray-400 dark:highlight-white/5">
            ...
            <div className="pt-6 mt-6 border-t border-gray-200 dark:border-gray-200/10">
              <button
                aria-label="Toggle Dark Mode"
                type="button"
                className="flex items-center justify-center w-full py-3 bg-gray-200 rounded-full dark:bg-onyx-hover general-ring-state"
                onClick={() =>
                  setTheme(resolvedTheme === 'dark' ? 'light' : 'dark')
                }
              >

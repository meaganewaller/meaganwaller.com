...
export default function About() {
  ...
  return (
    <div className="bg-desktopWallpaper2">
      ...
      >
        <div className="flex p-5 place-content-center flex-col bg-tertiary-lighter/30">
      ...
      <Window active={false} title="past issues" x={size.width / 8} y={size.height / 5} zIndex="0" width="300px">
        <div className="flex p-5 place-content-center flex-col bg-tertiary/20">
          <div className="flex place-content-center pb-4">
            <Broadcasts />
          </div>
        </div>
      ...
      <Window active={false} title="what the readers are saying" x={size.width / 5} y={size.height / 1.5} zIndex="0">
        <div className="flex py-6 place-content-center flex-row font-extra bg-secondary/50">
          <div className="inline-block px-3">
            <div className="relative w-56 animate-bounce">
              <div className="bg-secondary-dark p-3 rounded-2xl">
                <p className="text-secondary-lighter p-1">It&apos;s certaintly a newsletter that arrives in my e-mail inbox!</p>
              </div>
              <div className="w-0 h-0 border-[20px] border-solid border-transparent border-t-[35px] border-t-secondary-dark relative -z-1 -top-3 left-40 rotate-[22deg]" />
            </div>
          </div>
          <div className="inline-block px-3">
            <div className="relative w-56 animate-[bounce_4s_infinite]">
              <div className="bg-secondary-dark p-3 rounded-2xl">
                <p className="text-secondary-lighter p-1">Published so infrequently you&apos;ll forget you&apos;re subscribed to it</p>
              </div>
              <div className="w-0 h-0 border-[20px] border-solid border-transparent border-t-[35px] border-t-secondary-dark relative -z-1 -top-3 left-40 rotate-[22deg]" />
            </div>
          </div>
          <div className="inline-block px-3">
            <div className="relative w-56 animate-[bounce_3s_infinite]">
              <div className="bg-secondary-dark p-3 rounded-2xl">
                <p className="text-secondary-lighter p-1">Is this the form to submit typos I found on your website?</p>
              </div>
              <div className="w-0 h-0 border-[20px] border-solid border-transparent border-t-[35px] border-t-secondary-dark relative -z-1 -top-3 left-40 rotate-[22deg]" />
            </div>
          </div>
